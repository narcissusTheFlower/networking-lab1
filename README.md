...
Я выбираю беспроводной интрефейс wlan0.


Картинка 2
На рисунке 2 мы представлены перед главным рабочим пространством WireShark. Оно делится на 3 зоны:
1) Весь трафик, который способен увидеть выбранный сетевой интерфейс. В моем случае wlan0;
2) Расшифрованный выбраный пакет. Тут мы можем увидеть разную информацию о заголовках разного уровня;
3) Тут мы видим заголовок в зашифрованном виде. 
